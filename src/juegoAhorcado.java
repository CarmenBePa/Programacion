	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				do {
					//System.out.println(palabra); // esto muestra la palabra que es. Acuerdate de quitarlo
					...
					if(palabra.equals(mascaraString(mascara)))fin = true; //compara la mascara de guiones con la palabra secreta	
					if(fallos==0)fin=true;
					
				} while (!fin);
					if(fallos == 0) {System.out.println("¡Vaya! Has agotado las vidas, has perdido. Intentalo de nuevo");
					}
					else {
						System.out.println("¡Enhorabuena! Has acertado la palabra oculta.¡¡Has ganado!!");
					}
